...
docker-compose -f docker-compose.yml up -d cli orderer.example.com ca.org1.example.com peer0.org1.example.com ca.org2.example.com peer0.org2.example.com ca.org3.example.com peer0.org3.example.com 
